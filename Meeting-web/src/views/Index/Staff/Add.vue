            ...
            <a-form @submit="handleSubmit" layout="vertical" :autoFormCreate="(form)=>{this.form = form}"
                ...
                <a-row :gutter="24">
                    ...
                    <a-col :span="12">
                        ...
                        >
                            <a-date-picker disabled placeholder='请选择出生日期' :disabledDate="disabledDate" style="width: 100%"/>
                        </a-form-item>
                    </a-col>
                    <a-col :span="12">
                        <a-form-item
                                ...
                                :fieldDecoratorOptions="{rules: [{ type: 'email', message: '请输入正确邮箱格式!' }]}"
                        >
                            <a-input placeholder='请输入常用邮箱'/>
                        </a-form-item>
                    </a-col>
                    <a-col :span="12">
                        <a-form-item
                                ...
                                :fieldDecoratorOptions="{rules: [{ required: true, message: '请选择组织机构类型!' }], initialValue: '0'}"
                        >
                            <a-select placeholder='请选择组织机构类型'
                                      :getPopupContainer="triggerNode => triggerNode.parentNode"
                    ...
                    <a-col :span="12" v-show="windowState === '0'">
                        <a-form-item
                                label='后台'
                                fieldDecoratorId="office"
                                :fieldDecoratorOptions="{
                                rules: [{ required: windowState === '0', message: '请输入后台!' },{ max: 55, message: '长度不大于55!' }],
                                trigger: 'input',
                    ...
                    <a-col :span="12" v-show="windowState === '1'">
                        <a-form-item
                                label='窗口号'
                                fieldDecoratorId="windowId"
                                :fieldDecoratorOptions="{rules: [{ required: windowState === '1', message: '请选择窗口!' }]}"
                        >
                            <a-select placeholder='请选择窗口'
                                      :getPopupContainer="triggerNode => triggerNode.parentNode"
                                      :disabled="!organizationId">
                                <a-select-option v-for="item in windowList" :value='String(item.id)' :key="String(item.id)">
                                    {{item.name}}
                                </a-select-option>
                            </a-select>
                        </a-form-item>
                    ...
                    <a-col :span="12">
                        <a-form-item
                                ...
                                :fieldDecoratorOptions="{rules: [{ required: true, message: '请输入办公电话!' }]}"
                        >
                    ...
                    <a-col :span="12" v-if="modifyId">
                        <a-form-item
                                label='在职状态'
                                fieldDecoratorId="workingState"
                                :fieldDecoratorOptions="{rules: [{ required: true, message: '请选择在职状态!' }]}"
                        >
                            <a-select
                                    :disbabled="modifyId"
                                    placeholder='请选择在职状态'
                    ...
                    <a-col :span="12">
                        <a-form-item
                                ...
                                :fieldDecoratorOptions="{rules: [{ required: true, message: '请输入市民卡号!' },{ max: 25, message: '长度不大于25!' }]}"
                        >
        ...
        autoDoFn(async () => {
          ...
          if (res) {
            const {
              ...
              icon, windowState, attendanceState
            } = res.data;
            const windowRes = await getWindowAll({
              organizationId: organizationId,
            });
            if (windowRes) {
              this.windowList = windowRes.data;
            }
