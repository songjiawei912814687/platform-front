        ...
        <a-spin tip="正在加载中..." :spinning="viewLoading">
            <a-form layout="vertical" class="detail-view">
                <a-row :gutter="24">
                    ...
                    <a-col :span="24" style="margin-bottom: 24px">
                        <p class="des-label">退休人员</p>
                        <p class="des-content">{{ retireesName || '--'}}</p>
                    </a-col>
                    <a-col :span="12">
                        <a-form-item label='是否需要网管'>
                            {{viewData.isNeedNeetwork === undefined ? '否' : String(viewData.isNeedNeetwork) === '1' ? '是' : '否'}}
                        </a-form-item>
                    </a-col>
                    <a-col :span="12"></a-col>
                    <a-col :span="24" style="margin-bottom: 24px">
...
import { getDetail } from '@/remote/appointment';
