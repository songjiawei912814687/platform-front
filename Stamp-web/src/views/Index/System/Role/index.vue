    ...
    <div class="content-wrap">
        ...
        <div class="action">
            <a-button @click="handleDrawerToggle('addVisible', true)"
                      v-if="authorityActionList.indexOf('M_STAMP_SYSTEM_SETTING_ROLEMANAGEMENT_ADD') > -1">录入
            </a-button>
        </div>
        <div class="content">
            <a-table :columns="columns"
                ...
                <span slot="action" slot-scope="text, record">
                    <a href="javascript:;" @click="handleViewShow(record)"
                       v-if="authorityActionList.indexOf('M_STAMP_SYSTEM_SETTING_ROLEMANAGEMENT_VIEW') > -1">查看</a>
                    <template v-if="authorityActionList.indexOf('M_STAMP_SYSTEM_SETTING_ROLEMANAGEMENT_EDITOR') > -1">
                        <a-divider type="vertical"/>
                        <a href="javascript:;" @click="handleModifyShow(record)">编辑</a>
                    </template>
                    <template
                            v-if="authorityActionList.indexOf('M_STAMP_SYSTEM_SETTING_ROLEMANAGEMENT_PERMISSIONS') > -1">
                        <a-divider type="vertical"/>
...
<!--                    <template v-if="authorityActionList.indexOf('A_SYSTEM_SYSTEMSETTINGS_ROLEMANAGEMENT_DATAPERMISSIONS') > -1">
                    ...
                    <template
                            v-if="authorityActionList.indexOf('M_STAMP_SYSTEM_SETTING_ROLEMANAGEMENT_ROLEUSER') > -1">
                        <a-divider type="vertical"/>
                        <a href="javascript:;" @click="handleUsersShow(record)">角色用户</a>
                    </template>
                    <template v-if="authorityActionList.indexOf('M_STAMP_SYSTEM_SETTING_ROLEMANAGEMENT_DELETE') > -1">
                        <a-divider type="vertical"/>
