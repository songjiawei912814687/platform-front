        ...
        <a-row :gutter="24">
          ...
          <a-col :span="24">
            <a-form-item
              ...
              :fieldDecoratorOptions="{rules: [{ required: true, message: '请选择材料形式!'}]}"
            >
          ...
          <a-col :span="12">
            <a-form-item
              ...
              :fieldDecoratorOptions="{rules: [{ required: false, message: '请输入材料出具单位!'}]}"
            >
              <a-input placeholder="请输入材料出具单位"/>
            </a-form-item>
          </a-col>
          <a-col :span="24">
            <a-form-item
          ...
          <a-col :span="24">
            <a-form-item
              ...
              :fieldDecoratorOptions="{rules: [{ required: false, message: '请上传示例表!'}]}"
            >
              <a-upload
                action="/upload"
                name="file"
          ...
          <a-col :span="24">
            <a-form-item
              ...
              :fieldDecoratorOptions="{rules: [{ required: false, message: '请上传空白表!'}]}"
            >
              <a-upload
                action="/upload"
                name="file"
...
export default {
  ...
  props: ["addVisible1", "handleClose", "modifyId", "grainId", "orgId"],
  data() {
    return {
      addLoading: false,
      blankAttachmentList: [],
      ...
      options: [
        { label: "原件", value: "1" },
        { label: "复印件", value: "2" },
        { label: "原件或者复印件", value: "3" },
        { label: "纸质表格", value: "4" },
        { label: "普通电子文件", value: "5" },
        { label: "系统自动获取，无需申请者提交", value: "6" },
        { label: "系统自动获取，如数据不全则需申请者提交", value: "7" },
        { label: "原件扫描件", value: "8" },
        { label: "PDF格式电子文件", value: "9" }
      ],
      checkedList: []
    };
  },
        ...
        if (!err) {
          autoDoFn(async () => {
            ...
            const res = await formPost(this.modifyId, {
              ...
              meteriaOrganization: values.meteriaOrganization,
              name: values.name,
              necessarilyDescription: values.necessarilyDescription,
              remark: values.remark,
              requestDetail: values.requestDetail,
              ...
              exampleAttachmentList: this.fileList.map(item => ({
                ...
                url:
                  item.response.data[0].filePath !== undefined &&
                  item.response.data[0].filePath.indexOf("uploadFile") > -1
