    ...
    <div class="staff-modal">
        ...
        >
            <div class="staff-header">
                <a-row>
                    <a-col :span="3">
                        <p class="header__label">权力名称：</p>
                    </a-col>
                    <a-col :span="6">
                        <a-input v-model="searchParams.qlName" placeholder="请输入权力名称"></a-input>
                    </a-col>
                    <a-col :span="3">
                        <p class="header__label">涉及内容：</p>
                    </a-col>
                    <a-col :span="6">
                        <a-input v-model="searchParams.contentInvolve" placeholder="请输入涉及内容">
                        </a-input>
                    </a-col>
                    <a-col :span="6">
            ...
            <a-table :columns="membersColumns"
                     ...
                     :rowKey="record => String(record.qlFullId)"
...
import { getPage } from '@/remote/getGrain';
