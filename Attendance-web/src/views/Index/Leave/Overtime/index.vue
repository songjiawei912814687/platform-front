<template>
    <div class="content-wrap">
        <h2 class="content__title">加班管理</h2>
        <search-box @onSearch="handleSearch" @onReset="handleReset">
            <search-box-item label="申请人：">
                <a-input v-model="searchParams.employeesName" placeholder="请输入申请人姓名"/>
            </search-box-item>
        ...
        <div class="action">
            <a-button @click="approval"
                      v-if="authorityActionList.indexOf('A_ATTENDANCE_LEAVEMANAGEMENT_OVERTIMEAPPLICATION_ADD') > -1">申请
            </a-button>
        </div>
        <div class="content">
            <a-table :columns="columns"
                ...
                <span slot="action" slot-scope="text, record">
                    <a href="javascript:;" @click="handleViewShow(record)"
                       v-if="authorityActionList.indexOf('A_ATTENDANCE_LEAVEMANAGEMENT_OVERTIMEAPPLICATION_VIEW') > -1">查看</a>
                    <template
                            v-if="authorityActionList.indexOf('A_ATTENDANCE_LEAVEMANAGEMENT_OVERTIMEAPPLICATION_EDITOR') > -1">
                    ...
                    <template
                            v-if="authorityActionList.indexOf('A_ATTENDANCE_LEAVEMANAGEMENT_OVERTIMEAPPLICATION_DELETE') > -1">
                        <a-divider type="vertical" v-show="record.status === 0"/>
...
<script>
    ...
    import {getPage, getDel} from '@/remote/leaveOvertime';
