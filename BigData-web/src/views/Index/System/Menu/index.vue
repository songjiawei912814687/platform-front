<template>
    <div class="content-wrap">
        ...
        <!--</search-box>-->
        <div class="action">
            <a-button @click="handleDrawerToggle('addVisible', true)" v-if="authorityActionList.indexOf('A_SYSTEM_SYSTEMSETTINGS_MENUMANAGEMENT_ADD') > -1">录入</a-button>
        </div>
        <div class="content" style="top: 100px;">
            <a-table :columns="columns" :dataSource="data"
                ...
                <span slot="action" slot-scope="text, record">
                    <a href="javascript:;" @click="handleViewShow(record)" v-if="authorityActionList.indexOf('A_SYSTEM_SYSTEMSETTINGS_MENUMANAGEMENT_VIEW') > -1">查看</a>
                    <template v-if="authorityActionList.indexOf('A_SYSTEM_SYSTEMSETTINGS_MENUMANAGEMENT_EDITOR') > -1">
                        <a-divider type="vertical"/>
                        <a href="javascript:;" @click="handleModifyShow(record)">编辑</a>
                    </template>
                    <template v-if="authorityActionList.indexOf('A_SYSTEM_SYSTEMSETTINGS_MENUMANAGEMENT_DELETE') > -1">
                         <a-divider type="vertical"/>
                    ...
                    <template >
                        <a-divider type="vertical"/>
                        <a href="javascript:;" @click="action(record)" v-if="authorityActionList.indexOf('A_SYSTEM_SYSTEMSETTINGS_MENUMANAGEMENT_ACTIONMANAGEMENT') > -1">动作管理</a>
                    </template>
