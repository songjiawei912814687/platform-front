                ...
                <a-row :gutter="24">
                    <a-col :span="12">
                        <a-form-item
                                ...
                                :fieldDecoratorOptions="{rules: [{ required: true, message: '请输入参数名称!' },{ max: 105, message: '最多105个字符!' }]}"
                        >
                    ...
                    <a-col :span="12" >
                        <a-form-item
                                label='key'
                                fieldDecoratorId="configKey"
                                :fieldDecoratorOptions="{rules: [{ required: true, message: '请输入参数key值!' }]}"
                        >
                            <a-input placeholder='请输入参数key值' />
                        </a-form-item>
                    </a-col>
                    ...
                    <a-col :span="12" >
                        <a-form-item
                                label='value'
                                fieldDecoratorId="configValue"
                                :fieldDecoratorOptions="{rules: [{ required: true, message: '请输入参数value值!' }]}"
                        >
                            <a-input placeholder='请输入参数value值' />
                        </a-form-item>
                    </a-col>
                    ...
                    <a-col :span="12" >
                        <a-form-item
                                label='隶属模块'
                                fieldDecoratorId="resourceMoudle"
                                :fieldDecoratorOptions="{rules: [{ required: true, message: '请输入模块名称!' }]}"
                        >
                    ...
                    <a-col :span="12">
                        <a-form-item
                                ...
                                :fieldDecoratorOptions="{rules: [{ required: true, message: '请选择上级配置!' }]}"
                        >
                            <a-tree-select
                                    style="width: 100%"
                    ...
                    <a-col :span="12">
                        <a-form-item
                                ...
                                :fieldDecoratorOptions="{rules: [{ required: true, message: '请选择是否有效!' }]}"
                        >
...
import { formPost, getDetail } from '@/remote/configParameter';
    ...
    addVisible() {
      if (this.modifyId) {
        autoDoFn(async () => {
          ...
          if (res) {
            const {
                name,configKey,parentId,configValue,disPlayOrderBy,state,resourceMoudle
            } = res.data;
