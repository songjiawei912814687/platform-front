<template>
    <a-drawer :visible="employeeVisible"
              @close="handleClose"
              :loading="viewLoading"
              :destroyOnClose="true"
              :maskClosable="false"
                ...
                <a-row :gutter="24">
                    ...
                    <a-col :span="12">
                        <a-form-item label='头像'>
                            <img v-if="viewData.icon" :src="viewData.icon" style="width: 120px; height: 120px"
                                 alt="avatar"/>
                            <p v-else>无</p>
                        </a-form-item>
                    </a-col>
...
<script>
    ...
    import {getEmployeeDetail} from '@/remote/dtailView';
    ...
    export default {
        ...
        props: ['employeeVisible', 'handleClose', 'modifyId', 'resourceId'],
        data() {
            return {
                viewData: {},
                viewLoading: false,
            ...
            employeeVisible() {
                if (this.resourceId) {
                    autoDoFn(async () => {
                        ...
                        const res = await getEmployeeDetail({id: this.resourceId});
                        if (res) {
                            this.viewData = {
                                ...res.data,
