...
export const transformTree3 = (data, defaultCheckedKeys, halfCheckedKeys) => {
  if (data && data.length) {
      return data.map(item => {
          ...
          return {
              ...
              children: transformTree3(item.children, defaultCheckedKeys, halfCheckedKeys),
          }
      });
  }
  return [];
...
export const apiVersion = '/api-assistdecision';
