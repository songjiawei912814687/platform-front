<template>
    <Drawer :value="addVisible"
            ...
            <a-row :gutter="24">
                ...
                <a-col :span="24">
                    <a-form-item
                            label='发送状态'
                            fieldDecoratorId="description"
                            :fieldDecoratorOptions="{rules: [{ required: true, message: '请选择发送状态!'}]}">
                        <a-select placeholder='请选择发送状态'>
                ...
                <a-col :span="24">
                    <a-form-item
                            label='接收状态'
                            fieldDecoratorId="description"
                            :fieldDecoratorOptions="{rules: [{ required: true, message: '请选择接收状态!'}]}">
                        <a-select placeholder='请选择接收状态'>
                            <a-select-option value='0'>失败</a-select-option>
                            <a-select-option value='1'>成功</a-select-option>
                        </a-select>
                    </a-form-item>
                ...
                <a-col :span="24">
                    <a-form-item
                            label='回复状态'
                            fieldDecoratorId="description"
                            :fieldDecoratorOptions="{rules: [{ required: true, message: '请选择回复状态!'}]}">
                        <a-select placeholder='请选择回复状态'>
        ...
        <div class="drawer-footer">
            ...
            <a-button @click="handleSubmit" type="primary" :loading="addLoading">回复</a-button>
        </div>
    </Drawer>
</template>
...
import { getPage1 } from '@/remote/stencil';
...
export default {
  ...
  computed: {
    title() {
      return this.modifyId ? '已发短信' : '已发短信';
    },
  },
  watch: {
    addVisible() {
