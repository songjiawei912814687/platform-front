        ...
        <div class="searchBox">
            <div>
                <a-input-search
                        ...
                        style="width:90%;"
                />
                <a-button type='default' class="returnBack" @click="returnBack" style="width:5%;margin-right: 40px;">返回</a-button>
            </div>
        </div>
        <div class="btnSearch">
...
<style scoped lang="less">
    ...
    /*.ant-input-search .ant-input-search-enter-button .ant-input-affix-wrapper .ant-input-search .ant-input-search-enter-button{*/
        /*width: 90%;*/
    /*}*/
    /*.returnBack .ant-btn .ant-btn-default{*/
        /*width: 5%;*/
    /*}*/
    /*.keySearch {*/
        /*position: absolute;*/
        ...
        /*width: 300px;*/
    /*}*/
    /*.ant-input-affix-wrapper[data-v-8c9bafaa] {*/
        /*width: 95%;*/
    /*}*/
