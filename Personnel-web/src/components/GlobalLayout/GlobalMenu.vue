<template>
    <a-sider class="slider">
        ...
        <a-menu
                ...
                style="width: 200px"
        >
            <a-menu-item v-for="item in menuInitData" v-if="item.isShow === 0" :key="item.path">
  ...
  data() {
    return {
      ...
      icon: localStorage.getItem('icon'),
        employeesName: localStorage.getItem('employeesName') === undefined
                                        || localStorage.getItem('employeesName') === 'undefined'  ? '您好，'+localStorage.getItem('userName') : '您好，'+localStorage.getItem('employeesName'),
