<template>
    <div class="content-wrap">
        <h2 class="content__title">通讯录管理</h2>
        ...
        <div class="action">
            <a-button @click="handleDrawerToggle('addVisible', true)" v-if="authorityActionList.indexOf('A_PERSONNEL_ADDRESSBOOKMANAGEMENT_ADD') > -1">录入</a-button>
        </div>
        <div class="content">
            <a-table :columns="columns"
                ...
                <span slot="action" slot-scope="text, record">
                    <a href="javascript:;" @click="handleViewShow(record)" v-if="authorityActionList.indexOf('A_PERSONNEL_ADDRESSBOOKMANAGEMENT_VIEW') > -1">查看</a>
                    <template v-if="authorityActionList.indexOf('A_PERSONNEL_ADDRESSBOOKMANAGEMENT_EDITOR') > -1">
                        <a-divider type="vertical"/>
                        <a href="javascript:;" @click="handleModifyShow(record)">编辑</a>
                    </template>
                    <template v-if="authorityActionList.indexOf('A_PERSONNEL_ADDRESSBOOKMANAGEMENT_DELETE') > -1">
                        <a-divider type="vertical"/>
...
<script>
    ...
    import { getPage, getDel } from '@/remote/address';
